Проект пишется на микросервисной архетиктуре, однако на данный момент ещё не завершен, поэтому пока что используется стандартный Layout из шаблона, который будет меняться. Также какие-то страницы ещё не стилизованы.
