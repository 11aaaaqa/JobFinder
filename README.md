Проект пишется на микросервисной архитектуре, однако на данный момент ещё не завершен, поэтому пока что используется стандартный Layout из шаблона, который будет меняться. Какие-то страницы также ещё не стилизованы.
Проект включает в себя процесс регистрации пользователя как работника или работодателя на основе JWT токенов, а также подтверждение почты отправкой письма на неё.
...
Работодатель может создавать компанию, приглашать пользователей, зарегистрировавшихся как работодатели, принимать/отклонять их запросы на вступление, просматривать список коллег. Владелец компании по умолчанию может выполнять все действия от лица компании, например:
создавать, удалять, архивировать вакансии, обновлять информацию о компании, однако остальным пользователям, находящимся в компании и не являющихся её владельцем, для всех этих действий нужны разрешения, которые выдаются владельцем компании или теми, у кого есть
...
Также у работника есть статус, по которому его резюме будет или не будет отображаться в списке у работодателя
