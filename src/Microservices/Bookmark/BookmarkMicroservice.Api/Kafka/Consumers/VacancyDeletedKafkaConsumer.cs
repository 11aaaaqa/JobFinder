...
{
    public class VacancyDeletedKafkaConsumer(IConfiguration configuration, IServiceScopeFactory scopeFactory) : BackgroundService
    {
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            const string topicName = "vacancy-deleted-topic";
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                context.FavoriteVacancies.RemoveRange(vacanciesToDelete);
