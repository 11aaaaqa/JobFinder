...
namespace ResponseMicroservice.Api.Services.Pagination
{
    public interface ICheckForNextPageExistingService
    {
        ...
        Task<bool> DoesNextInterviewInvitationsByCompanyIdPageExistAsync(Guid companyId, string? searchingQuery, DateTimeOrderByType orderByTimeType,
            int currentPageNumber);
        Task<bool> DoesNextInterviewInvitationsByEmployeeIdPageExistAsync(Guid employeeId, string? searchingQuery,
            DateTimeOrderByType orderByTimeType, int currentPageNumber);
        Task<bool> DoesNextCompanyInterviewInvitationsByVacancyIdPageExistAsync(Guid vacancyId, string? searchingQuery, DateTimeOrderByType orderByTimeType,
            int currentPageNumber);
    }
}
